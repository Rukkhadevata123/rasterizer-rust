...
- [ ] Finish the current operational documentation by rewriting benchmark documentation. README, the rendering API guide, examples, and module documentation already describe only the implemented API and current contracts; migration history remains only in the temporary tracked plan until archival.
